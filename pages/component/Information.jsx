            ...
            <div className=' flex flex-col  mt-3'>
                ...
                <div className='md:mt-28 mt-8' data-aos="fade-up" data-aos-duration="700">
                    <div className='space-y-3'>
                        <p className='lg:text-4xl text-md font-light lg:w-2/3'>Designing digital experiences that captivate and inspire.
                        </p>
                        <h1 className='md:text-6xl text-4xl font-normal'>welcome to my <b>portfolio!</b></h1>
                    </div>
                    <div className='mt-10 md:mt-20'>
                        <p className='md:w-2/3 md:text-xl text-sm font-light'>I am <span className='text-[#4C89F8]'>omkar chandrakant waje</span>.<br></br>
                ...
                <div className='mt-16 md:mt-28 px-6 md:w-2/3 flex flex-row justify-between'>
                    <div className=''>
                        ...
                        <p className='text-xl md:text-3xl '>Projects Done</p>
                    </div>
                    <div className=''>
