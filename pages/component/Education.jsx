...
const Education = (props) => {
  return (
    ...
    <div className='flex flex-col md:flex-row w-full justify-between md:items-center'>
        ...
        <p className='font-medium text-sm lg:text-xl 2xl:text-3xl mt-2 md:mt-0'>
            {props.period}
        </p>
    </div>
    <h1 className='text-lg 2xl:text-2xl'>{props.board}</h1>
    <h1 className='text-lg 2xl:text-2xl'>{props.status}</h1>
</div>
  )
}
